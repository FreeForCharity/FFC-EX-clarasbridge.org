    ...
    <div>
      ...
      <section id="hero" className="bg-[#EEEBED] py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto" id="lato-font">
            Supporting individuals rebuilding their lives in recovery through
            structured mentorship, accountability, and community connections.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            ...
            <div className="space-y-4 text-gray-600" id="lato-font">
              <p>
                Clara&apos;s Bridge supports individuals rebuilding their lives in recovery
                by providing structured mentorship, regular check-ins, and connections to
                community resources. The program helps participants rebuild routines,
                strengthen accountability, and develop practical tools needed for stable,
                independent living after treatment.
              </p>
              <p>
                With guidance from mentors who understand the recovery journey, participants
                gain encouragement, perspective, and a sense of connection during one of the
                most vulnerable stages of recovery. Clara&apos;s Bridge also recognizes the
                importance of supporting families and loved ones who are walking alongside
                someone in recovery.
              </p>
              <p>
                We hope to involve parents who have lost a child to addiction, offering them
                a meaningful way to support other families facing similar struggles. Their
                lived experience brings a level of understanding that cannot be taught.
              </p>
            </div>
          </div>
      ...
      <section id="our-story" className="py-16 px-4 bg-[#EEEBED]">
        <div className="max-w-4xl mx-auto">
          <h2
            className="text-3xl font-normal mb-6 text-center"
            id="faustina-font"
          >
          ...
          <p className="text-gray-600 text-center max-w-3xl mx-auto" id="lato-font">
            ...
            including one that lasted 18 months. Each time she returned home, we loved and
            supported her, but we often didn&apos;t know how to help her stay stable in
            recovery. I saw how little guidance exists after treatment ends. Clara&apos;s
            Bridge was created so people leaving rehab have support, direction, and hope
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600" id="lato-font">
                Help navigating real-life challenges that come with rebuilding a stable life
                in recovery.
              </p>
            </div>
            <div className="text-center p-6">
